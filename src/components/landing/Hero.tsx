  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-black via-gray-900 to-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        >
          <p className="text-cyan-400 text-sm md:text-base font-semibold tracking-wider mb-6 uppercase">
            LaunchPad
          </p>
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-400 mb-12 max-w-4xl mx-auto font-medium tracking-wide">
            DELIVER YOUR WEB CONTENT AT WARP SPEED WITH LAUNCHPAD
          </p>
